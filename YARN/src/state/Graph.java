...
public class Graph {
  ...
  private static String wrapSafeString(String label) throws Exception {
    if (label.indexOf(',') >= 0) {
      if (label.length()>14) {
  ...
  public String generateGraphViz(String indent) throws Exception {
  ...
  public String generateGraphViz() throws Exception {
