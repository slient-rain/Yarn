...
/**
 * 节点上资源的一些统计信息+分配出去的container信息+RMNode
 * @author 无言的雨
 *
 */
public class SchedulerNode {
	...
	/**
	 * 在node remove时，遍历这些containers进行释放
	...
	private synchronized void addAvailableResource(Resource resource) {
		...
		addTo(availableResource, resource);
		subtractFrom(usedResource, resource);
	}
	...
	private synchronized void deductAvailableResource(Resource resource) {
		...
		subtractFrom(availableResource, resource);
		addTo(usedResource, resource);
	}	
