...
/**
 * resourceManager的启动时间clustertimestamp+累加计数器id
 ...
 */
public class ApplicationId implements Comparable<ApplicationId> ,Writable{
	...
	public ApplicationId(int id, long clusterTimestamp) {
		super();
		this.id = id;
	...
	public static ApplicationId newInstance(long clusterTimestamp, int id) {
	   return new ApplicationId(id, clusterTimestamp);
	}
	/**
	...
	public void write(DataOutput out) throws IOException {
		out.writeInt(id);
		out.writeLong(clusterTimestamp);
